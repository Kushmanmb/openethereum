...
Options:
    ...
    -b, --brain        Use OpenEthereum brain wallet algorithm. Not recommended.
...
fn validate_phrase(phrase: &str) -> String {
    match Brain::validate_phrase(phrase, BRAIN_WORDS) {
        ...
        Err(err) => format!("The recovery phrase was not generated by OpenEthereum: {}", err),
    }
}
...
address: 26d1ec50b4e62c1d1a40d16e7cacc6a6580757d5".to_owned();
    ...
    fn brain() {
        ...
        let expected =
"The recovery phrase was not generated by OpenEthereum: The word 'this' does not come from the dictionary.
